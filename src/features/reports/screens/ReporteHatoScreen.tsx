...
export function ReporteHatoScreen({ onBack }: ReporteHatoScreenProps) {
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      >
        ...
        <View style={styles.infoCard}>
          ...
          {[
            'Número de arete de cada animal activo',
            'Especie, sexo y estado sanitario',
            'Peso actual registrado en kg',
        ...
        >
          <Text style={styles.generateButtonText}>
            {cargando ? 'Generando…' : '📄 Generar PDF del Hato'}
          </Text>
        </Pressable>
      </ScrollView>
    </SafeAreaView>
